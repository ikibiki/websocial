...
class LinkedIn {
    ...
    public function getAccessToken($authorization_code = null) {
        ...
        $data = $this->_makeRequest(self::OAUTH_BASE . '/accessToken?' . $params, array(), self::HTTP_METHOD_GET);
//        $data = $this->_makeRequest(self::OAUTH_BASE . '/accessToken?', $params, self::HTTP_METHOD_POST);
     ...
     * @return array
     */
    public function fetch($endpoint, array $payload = array(), $method = 'GET', array $headers = array()) {
     ...
     * @return array
     */
    protected function _makeRequest($url, array $payload = array(), $method = 'GET', array $headers = array()) {
